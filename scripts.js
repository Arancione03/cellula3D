document.addEventListener('DOMContentLoaded', () => {
    const cellule = [
        ...
        [
            ...
            { name: 'Involucro nucleare', description: "L'involucro nucleare è una doppia membrana che avvolge il nucleo della cellula, separandolo dal citoplasma. Questa struttura protegge il DNA e regola il traffico di molecole attraverso pori nucleari, permettendo il passaggio controllato di RNA, proteine e altri fattori essenziali. La membrana esterna dell'involucro è continua con il reticolo endoplasmatico rugoso, facilitando l'interazione tra nucleo e citoplasma.", modelPath: 'modelli/vegetale/involucro nucleare.glb' },
            ...
            { name: 'Cloroplasto', description: "I cloroplasti sono organuli esclusivi delle cellule vegetali, responsabili della fotosintesi. Contengono clorofilla, il pigmento che cattura l'energia luminosa. Il cloroplasto è delimitato da una doppia membrana e possiede un sistema di membrane interne formanti tilacoidi, dove avvengono le reazioni. I cloroplasti hanno il proprio DNA e ribosomi. Sono fondamentali per la produzione di glucosio e ossigeno, che servono per produrre ATP dai mitocondiri.", modelPath: 'modelli/vegetale/cloroplasto.glb' },
